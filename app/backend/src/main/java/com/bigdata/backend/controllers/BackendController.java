...
public class BackendController {
    ...
    public boolean validateImportConfiguration(@Valid @RequestBody List<ImportConfig> config) {
        return true;
    }
    ...
    public NodesCountResponse getNodesCount(@Valid @RequestBody NodesCountRequest nodesCountRequest) {
